...
export default class GameUI extends ui.test.TestSceneUI {
  constructor() {
    ...
    //添加方向光
    var directionLight: Laya.DirectionLight = scene.addChild(
    ...
    //添加自定义模型
    var box: Laya.MeshSprite3D = scene.addChild(
      new Laya.MeshSprite3D(Laya.PrimitiveMesh.createBox(1, 1, 1))
    ...
    const changeSkin = () => {
      ...
      Laya.Texture2D.load(
        flag ? "res/atlas/comp.png" : "res/layabox.png",
        Laya.Handler.create(null, function (tex: Laya.Texture2D) {
          material.albedoTexture = tex;
        })
      );
